...
public class OrderDB extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(String.format("CREATE TABLE %s(%s INTEGER PRIMARY KEY" +
                        " AUTOINCREMENT, %s TEXT NOT NULL UNIQUE, %s TEXT NOT NULL, %s TEXT NOT NULL, %s NOT NULL)",
                Tables.DEPT_EMP,
                BaseColumns._ID,
                OrderContract.DeptEmps.ID,
                OrderContract.DeptEmps.FROMDATE,
                OrderContract.DeptEmps.TODATE,
                OrderContract.DeptEmps.EMPNO));
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS "+Tables.DEPT_EMP);
        onCreate(db);
